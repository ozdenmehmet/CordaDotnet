#pragma checksum "C:\Users\sncrh\Desktop\CordaApp\CordaApp\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "865022789baea9072453eaf88851d621db5776e3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"865022789baea9072453eaf88851d621db5776e3", @"/Views/Home/Index.cshtml")]
    ...
    <div class=""row"">
        <div class=""col-lg-6"">
            ...
            <div class=""table-content pd-b-10"" style=""background-color: #ffffff;border-radius:30px;"">
                ...
                <table class=""table table-borded tableCustom"" id=""ta");
            WriteLiteral("ble-list\" style=\"padding-left: 20px;text-align: left;padding-right: 20px;\">\r\n                    <tbody id=\"fundTbody\">\r\n");
#nullable restore
...
#nullable disable
        ...
        <div class=""col-lg-6"">
            ...
            <div class=""table-content pd-b-10"" style=""background-color: #ffffff;border-radius:30px;"">
                <div class=""row mg-x-0 mg-b-15"" style=""height:30px;background-color: #ffffff;border-radius: 30px 30px 0 0;"">
                    <div class=""col-lg-6 pd-l-20 pd-y-10"" style=""font-size: 21p");
            WriteLiteral(@"x;font-weight:500;color:#C7C7C7;"">INVESTOR POOL</div>
                    <div class=""col-lg-6 d-flex align-items-center pd-r-35"">
                        ...
                        <div class=""form-row"">
                            <div class=""col-lg-6 pd-r-25-force"">
                                <select class=""form-control pd-l-0"" style=""background:transparent;border:none;border-bottom: 1px solid rgba(0, 0, 0, 0.1);"" id=""subsName"">
                                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "865022789baea9072453eaf88851d621db5776e317392", async() => {
...
#nullable disable
            WriteLiteral("                                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "865022789baea9072453eaf88851d621db5776e318859", async() => {
#nullable restore
    ...
    <script>
      ...
      ");
            ...
            $(""#addInv"").click(function () {
                ...
                $(""#inves");
                WriteLiteral(@"torBody"").append(""<tr style='background:rgba(232, 235, 240, 0.4)'>"" +
            ...
            $(""#addSub"").click(function () {
                ...
                $(""#subsBody"").append(""<tr class='d-flex mg-t-20 mg-r-20'>"" +
                    ...
                    ""<td name='subsName' class='col-lg-6 customTd mg-r-20 subsName' style='padding-top:6px;padding-bottom:6px;background: rgba(232, 235, 240, ");
                WriteLiteral(@"0.4)' onclick='onColumnSelect(this)'>"" + subsName + ""</td>"" +
                    ""<td name='subsAmount' class='col-lg-6 customTd' style='padding-top:6px;padding-bottom:6px;background: rgba(232, 235, 240, 0.4)'>$ "" + subsAmount + ""</td>"" +
                    ""</tr>"");
        ...
        $(""#removeSubs"").click(function () {
            ...
            var fundId = tr.find(""td:eq(0)"").text();
            v");
                WriteLiteral(@"ar invId = tr.find(""td:eq(1)"").text();
                    ...
                    $.each(subsList, function (index, value) {
                        if (value.fundid != null) {
                            ...
                            $(""#subsBody"").append(""<tr class='d-flex"" + trTop + ""mg-r-20'>"" +
                                ...
                                ""<td name='userId' class='d-none'>""");
                WriteLiteral(@" + value.userid + ""</td>"" +
                                ""<td name='subsName' class='col-lg-6 customTd mg-r-20 subsName' style='padding-top:6px;padding-bottom:6px;background: rgba(232, 235, 240, 0.4)' onclick='onColumnSelect(this)'>"" + value.investorname + ""</td>"" +
